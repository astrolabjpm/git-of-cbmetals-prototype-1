...
/* ═══ PRODUCTS — exact copy of mega menu ═══ */
const ProductsMenu = () => {
  ...
  return (
    <div className="border-t-2 border-accent bg-card shadow-lg shadow-foreground/20">
      <div className="mx-auto grid max-w-[1400px] grid-cols-[260px_1fr_220px]">
        ...
        <div className="flex flex-col gap-4 border-l border-border bg-cta p-5">
          ...
          <Link
            to="/products"
            className="rounded-sm bg-accent py-2.5 text-center text-[13px] font-bold text-accent-foreground transition-colors hover:bg-accent-hover hover:shadow-sm"
          >
            Request a Quote →
          </Link>
...
/* ═══ GALLERY — exact copy of mega menu ═══ */
const GalleryMenu = () => (
  <div className="border-t-2 border-accent bg-card shadow-lg shadow-foreground/20">
...
/* ═══ RESOURCES — exact copy of mega menu ═══ */
const ResourcesMenu = () => (
  <div className="border-t-2 border-accent bg-card shadow-lg shadow-foreground/20">
...
/* ═══ LOCATIONS — exact copy of mega menu ═══ */
const LocationsMenu = () => (
  <div className="border-t-2 border-accent bg-card shadow-lg shadow-foreground/20">
...
/* ═══ ABOUT — exact copy of mega menu ═══ */
const AboutMenu = () => (
  <div className="border-t-2 border-accent bg-card shadow-lg shadow-foreground/20 inline-block min-w-[180px] rounded-b-sm border border-border">
...
const MenuPage = () => {
  ...
  const MenuContent = section ? menuComponents[section] : null;

  if (!MenuContent) {
    return (
      <div className="min-h-screen">
        <SiteNav />
        <div className="py-20 text-center text-muted-foreground">Menu not found.</div>
        <FooterNav />
      </div>
    );
  }
